...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 28430134)
	API_HASH = os.environ.get("API_HASH", "c3cd07e1c60c6ab046ef34a8d5aa7514")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6617564043:AAGyd4h18IZ_NBNLo2vJarJp1MRdOdThOak")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "MissRose_Rosbot)
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001973035018)
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5992637806"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://nk887147:<Mhakal4141>@cluster0.9hh6if4.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001863391215)
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001898523937")
