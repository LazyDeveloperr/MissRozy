...
class Config(object):
	API_ID = int(os.environ.get("22349232"))
	API_HASH = os.environ.get("190d65ed459ba1b8e047483914e30756")
	BOT_TOKEN = os.environ.get("5832681391:AAGJQl0bLLHrg9EWmPnj8wYwmgT4YVQa7pk")
	BOT_USERNAME = os.environ.get("Ns movies")
	DB_CHANNEL = int(os.environ.get("Ns_moviez"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "22349232"))
	DATABASE_URL = os.environ.get("https://t.me/+x1RTNvhp1FM0YmI1")
